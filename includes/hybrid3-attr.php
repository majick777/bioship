...
function hybrid_attr_sidebar( $attr, $context ) {
	...
	if ( $context ) {
		...
		if ( $sidebar_name ) {
			...
			$attr['aria-label'] = esc_attr( sprintf( _x( '%s Sidebar', 'sidebar aria label', 'bioship' ), $sidebar_name ) );
		}
	}
...
function hybrid_attr_menu( $attr, $context ) {
	...
	if ( $context ) {
		...
		if ( $menu_name ) {
			...
			$attr['aria-label'] = esc_attr( sprintf( _x( '%s Menu', 'nav menu aria label', 'bioship' ), $menu_name ) );
		}
	}

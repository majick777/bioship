...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_attr__( 'Ultra-Light 100', 'bioship' ),
			'100light'  => esc_attr__( 'Ultra-Light 100', 'bioship' ),
			'100italic' => esc_attr__( 'Ultra-Light 100 Italic', 'bioship' ),
			'200'       => esc_attr__( 'Light 200', 'bioship' ),
			'200italic' => esc_attr__( 'Light 200 Italic', 'bioship' ),
			'300'       => esc_attr__( 'Book 300', 'bioship' ),
			'300italic' => esc_attr__( 'Book 300 Italic', 'bioship' ),
			'400'       => esc_attr__( 'Normal 400', 'bioship' ),
			'regular'   => esc_attr__( 'Normal 400', 'bioship' ),
			'italic'    => esc_attr__( 'Normal 400 Italic', 'bioship' ),
			'500'       => esc_attr__( 'Medium 500', 'bioship' ),
			'500italic' => esc_attr__( 'Medium 500 Italic', 'bioship' ),
			'600'       => esc_attr__( 'Semi-Bold 600', 'bioship' ),
			'600bold'   => esc_attr__( 'Semi-Bold 600', 'bioship' ),
			'600italic' => esc_attr__( 'Semi-Bold 600 Italic', 'bioship' ),
			'700'       => esc_attr__( 'Bold 700', 'bioship' ),
			'700italic' => esc_attr__( 'Bold 700 Italic', 'bioship' ),
			'800'       => esc_attr__( 'Extra-Bold 800', 'bioship' ),
			'800bold'   => esc_attr__( 'Extra-Bold 800', 'bioship' ),
			'800italic' => esc_attr__( 'Extra-Bold 800 Italic', 'bioship' ),
			'900'       => esc_attr__( 'Ultra-Bold 900', 'bioship' ),
			'900bold'   => esc_attr__( 'Ultra-Bold 900', 'bioship' ),
			'900italic' => esc_attr__( 'Ultra-Bold 900 Italic', 'bioship' ),
		);
	}
